...
<section id="motor01">
    <div class="container py-5">
        ...
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="./motor_selection125.php">125cc</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="./motor_selection150.php">150cc</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="./motor_selection_electric.php">電動車</a>
            </li>
        </ul>
        <!-- 車型 -->
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-6">
            <!-- 查詢機車資料 -->
            <?php
            $sql = "SELECT * FROM motor_product WHERE motor_type = '125cc'";
            ...
            ?>
                    <div class="col text-center">
                        ...
                        <div class="card-body my-3">
                            <h4 class="card-title" style="word-wrap: break-word;"><?= $row['motor_name'] ?></h4>
