...
<section id="motor01">
    <div class="container py-5">
        ...
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="./motor_selection150.php">150cc</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-6">
            <!-- 查詢機車資料 -->
            <?php
            $sql = "SELECT * FROM motor_product WHERE motor_type = '150cc'";
            ...
            <?php
                ...
                echo '<p class="text-center">目前無 150cc 的車輛提供。</p>';
            }
